...
**The SOUL.md Template Behind My Hermes Agent (Never Shared This Before) **  
  
## After writing about the SOUL.md file running my Hermes Agent, most people asked to share it  
## My raw file has active project names, private file paths, tool habits, cleanup debt, and autonomy rules written for my specific workflows. Sharing that isn't useful to you. It's just noise with my life attached.  
## So I built a sanitized template instead.  
**The template**  
## Copy this into a file called SOUL.md in your agent setup. Then actually customize it. The generic version gets you a generic operator.  
# SOUL  
...
## Drop this into your agent setup as a system file, context file, or project instruction file, depending on your framework.  
## The sections that matter most: Stance, Autonomy, and Mission. Those three decide whether the agent acts like an operator or stalls waiting for direction.  
## Update the Mission section whenever priorities shift. If the agent keeps producing work you ignore, fix the Accountability section. If it asks permission too often, tighten the Autonomy boundary.  
